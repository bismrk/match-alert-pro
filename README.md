...
I want to create an application that would be frontend for this, and I already want to start thinking about creating its backend. So right now for the backend, I want you to just mock the calls to backend, and then later I will implement backend by myself.
...
Team Subscription & Automated Scheduling: Users select teams. Backend fetches schedules via Mock Football API.

Smart Notification System: Custom reminder intervals (5 days, 2 days, 2 hours). Sent via Telegram.

"Bet Placed" Status (Snooze Logic): Marking a match stops betting reminders.

Urgency-Based Dashboard: Sleek, dark-mode UI with live countdown timers, color-coded by urgency.
...
Continue developing this project in the [Lovable editor](https://lovable.dev/projects/f34861c4-2e63-44f3-ab02-75ed9a90ab9a).
